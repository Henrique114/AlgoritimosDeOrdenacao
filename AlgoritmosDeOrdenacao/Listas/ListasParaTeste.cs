...
namespace AlgoritmosDeOrdenacao.Code.Listas
{
    public static class ListasParaTeste
    {
        ...
        public static int[] desordenados = { 50, 48, 33, 99, 45, 22, 34, 11, 57, 1, 5, 9 };

        // - numeros desordenados repetidos:
        public static int[] desordenadosRepetidos = { 4, 4, 6, 5, 6, 5, 1, 1, 1, 2, 1, 6, 2, 2, 2 };
